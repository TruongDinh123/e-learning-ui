...
async function handleLogout() {
  try {
    ...
    await axios({
      method: 'post',
      url: 'https://e-learning-95lab-productionv1.onrender.com/v1/api/e-learning/logout',
      headers: {
...
async function refreshToken() {
  try {
    ...
    const response = await axios({
      method: 'post',
      url: 'https://e-learning-95lab-productionv1.onrender.com/v1/api/e-learning/handleRefreshToken',
      headers: {
        'x-api-key': '8ccaf2db9e10264dc29abdcc653f1c59673144131bd08c870751ce80490d926c407ad256fcf7c409df42c6af17f779b94c2695b769f3d1eb76f726e97a12773b',
